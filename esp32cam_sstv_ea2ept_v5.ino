...
void setup() {
  ...
  */
  ...
  // Stabilization delay to let power rails settle before talking to SD card after deep sleep wake
  delay(200);

  // 3. SD Card Initialization Check
  if(!SD_MMC.begin("/sdcard", true)){
    Serial.println("SD_CARD - NONE - [FAIL]");
  } else {
